...
@property (assign) CGFloat holeWeith;
@property (assign) CGFloat holeHeight;
@end
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (JMHole* hole in self.holes) {
        ...
        if (hole.holeType == JMHoleTypeRoundedRect) {
            ...
            CGRect rectInView = CGRectMake(floorf(circleHole.holeCenterPoint.x - circleHole.holeWeith*0.5f),
                                           floorf(circleHole.holeCenterPoint.x - circleHole.holeHeight*0.5f),
                                           circleHole.holeWeith,
                                           circleHole.holeHeight);
...
- (NSInteger)addHoleCircleCenteredOnPosition:(CGPoint)centerPoint andHoleWeith:(CGFloat)weith andHoleHeight:(CGFloat)height
{
    ...
    circleHole.holeWeith = weith;
    circleHole.holeHeight = height;
